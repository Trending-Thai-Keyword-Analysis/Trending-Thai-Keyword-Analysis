...
#define __PYX_HAVE__Method
#define __PYX_HAVE_API__Method
/* Early includes */
#include <string.h>
#include <stdlib.h>
#include <stdio.h>
...
static char const **__pyx_f_6Method_to_cstring_array(PyObject *__pyx_v_list_str, int __pyx_v_length) {
 ...
 * 
 */
    __pyx_t_4 = __Pyx_GetItemInt(__pyx_v_list_str, __pyx_v_i, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 12, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_WriteUnraisable("Method.to_cstring_array", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
 ...
 * 
 */
  __pyx_v_c_arr1 = __pyx_f_6Method_to_cstring_array(__pyx_v_S1, __pyx_v_m);
 ...
 *     result = []
 */
  __pyx_v_c_arr2 = __pyx_f_6Method_to_cstring_array(__pyx_v_S2, __pyx_v_n);
 ...
 *                         k = 0
 */
              __pyx_t_14 = __Pyx_PyList_Append(__pyx_v_result, __pyx_v_LCS); if (unlikely(__pyx_t_14 == ((int)-1))) __PYX_ERR(0, 47, __pyx_L6_error)
 ...
 *                         result.append(LCS)
 */
              __pyx_t_13 = PyUnicode_DecodeUTF8((__pyx_v_c_arr1[((__pyx_v_i - 1) - __pyx_v_k)]), strlen((__pyx_v_c_arr1[((__pyx_v_i - 1) - __pyx_v_k)])), ((char const *)"surrogateescape")); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 53, __pyx_L6_error)
              __Pyx_GOTREF(__pyx_t_13);
              __pyx_t_4 = PyNumber_Add(__pyx_t_13, __pyx_v_LCS); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 53, __pyx_L6_error)
              __Pyx_GOTREF(__pyx_t_4);
 ...
 *         return result,len
 */
            __pyx_t_14 = __Pyx_PyList_Append(__pyx_v_result, __pyx_v_LCS); if (unlikely(__pyx_t_14 == ((int)-1))) __PYX_ERR(0, 55, __pyx_L6_error)
 ...
 */
    ...
    __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_len); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 57, __pyx_L6_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_13 = PyTuple_New(2); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 57, __pyx_L6_error)
    __Pyx_GOTREF(__pyx_t_13);
...
static PyObject *__pyx_pw_6Method_1lcs(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("lcs (wrapper)", 0);
  {
    ...
    __pyx_v_S1 = values[0];
    __pyx_v_S2 = values[1];
    __pyx_v_m = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_m == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 15, __pyx_L3_error)
...
static int __pyx_pymod_exec_Method(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_Method},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initMethod(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initMethod(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_Method(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_Method(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_Method(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'Method' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_Method(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("Method", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_Method) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "Method")) {
      if (unlikely(PyDict_SetItemString(modules, "Method", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init Method", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init Method");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
